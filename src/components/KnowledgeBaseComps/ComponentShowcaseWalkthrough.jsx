...
export default function ComponentShowcaseWalkthrough() {
  ...
  return (
    <div
      style={{
        padding: '2rem',
        border: isDark ? '1px solid #3f3f3f' : '1px solid #d8d8d8',
    ...
    >
      ...
      >
        {/* Sample UI components (swap in real ones later) */}
        <button style={{
          padding: '0.6rem 1.2rem',
          borderRadius: '6px',
          border: 'none',
          backgroundColor: isDark ? '#00b7ff' : '#3f8cff',
          color: '#fff',
          fontWeight: 600,
          cursor: 'pointer'
        }}>
        ...
        <span style={{
          ...
          backgroundColor: isDark ? '#3f3f3f' : '#e0e0e0',
        ...
        <div style={{
          padding: '0.8rem',
          backgroundColor: isDark ? '#292f3d' : '#f4f4f4',
          borderRadius: '8px',
